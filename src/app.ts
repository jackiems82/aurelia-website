...
export class App {
  ...
  configureRouter(config: RouterConfiguration, router: Router): void {
    ...
    config.map([
      ...
      { route: 'projects',    title: 'Projekte',    name: 'projects',     moduleId: 'pages/projects', nav:true, settings: {isMainNav: true, t:'navigation.projects'} },
      { route: 'about',       title: 'Info',       name: 'about',        moduleId: 'pages/about.html', nav:true, settings: {isMainNav: true, t:'navigation.about'} },
